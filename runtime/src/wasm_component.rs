...
// pub struct StateRef(Arc<RwLock<Option<Builder>>>);
// impl StateRef {
// 	pub fn empty() -> Self {
// 		Self(Arc::new(RwLock::new(None)))
// 	}
	
// 	pub fn set(&mut self, inner: Builder) -> Result<()> {
...
// 	pub fn read(&self) -> RwLockReadRef<Builder> {
// 		debug!("read");
// 		RwLockReadRef(self.0.try_read())
// 	}

// 	pub fn write(&self) -> RwLockWriteRef<Builder> {
// 		debug!("write");
